...
public class EmployeeManagementController extends HttpServlet {
	...
	public void requestHelper(HttpServletRequest request, HttpServletResponse response)
		...
		if (param == null) {
			...
			if (param != null && param.equals("save_comment") && cancelParm == null) {
				...
				// need to get id for current logged in user from session and
	...
	public void getComplianceList(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, ServletException, IOException {
		compRepo = new ComplianceRepository();
	...
	public void setLoggedInUser(HttpServletRequest request, HttpServletResponse response)
	...
	public void doBeforeReturnToDashBoard(HttpServletRequest request, HttpServletResponse response)
			throws NumberFormatException, IOException, SQLException, ServletException {
